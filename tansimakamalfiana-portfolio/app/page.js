        ...
        <div className={size.width < 1000 ? "flex-col text-black" : "flex text-black"}>
          ...
          <div className="flex-col justify-center ">
            ...
            <div className="flex w-full justify-evenly m-auto py-8 px-24">
              <Buttons text="PORTFOLIO" href="../pages/PortfolioPage" bgcolor="hover:bg-[#ffee32]" className={size.width < 1000 ? "text-xl p-2" : "text-2xl p-2"}/>
              <Buttons text="RESUME" href="../pages/ResumePage" bgcolor="hover:bg-[#f77f00]" className={size.width < 1000 ? "text-xl p-2" : "text-2xl p-2"}/>
              <Buttons text="CONTACT" href="../pages/ContactPage" bgcolor="hover:bg-[#ED4672]" className={size.width < 1000 ? "text-xl p-2" : "text-2xl p-2"}/>
            </div>
          </div>
        </div>
      </div>
